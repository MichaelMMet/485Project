...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // Fetch locker data from backend
    fetch("http://localhost:3307/api/lockers")
  ...
  const customers = occupied
    ...
    .filter((c) => c.id !== null); // Remove null entries
    ...
    <main style={styles.page}>
      ...
      <div style={styles.sections}>
        ...
        <section style={styles.card}>
          ...
          <p>
            <strong>Occupied:</strong> {occupied.length}
          </p>
          <p>
            <strong>Vacant:</strong> {vacant.length}
          </p>
        </section>
        ...
        <div style={styles.lockerGrid}>
          {lockers.map((locker) => (
            ...
            >
              ...
              <p>{locker.occupied ? locker.name : "Vacant"}</p>
            </Link>
          ))}
        </div>
      </section>
